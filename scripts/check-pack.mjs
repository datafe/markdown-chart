...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      "import { LegacySandboxError, createLegacySandboxClient, createLegacySandboxErrorClassifier, createLegacySandboxHostAdapter, waitForLegacySandboxAbortable } from '@datafe-open/markdown-chart-echarts';",
  ...
  writeFileSync(path.join(consumerDirectory, 'strict-consumer.ts'), [
    ...
    "import { LegacySandboxError, createLegacySandboxClient, createLegacySandboxErrorClassifier, createLegacySandboxHostAdapter, waitForLegacySandboxAbortable, type LegacySandboxAbortablePromiseLike, type LegacySandboxBinding, type LegacySandboxContext, type LegacySandboxErrorClassifierOptions, type LegacySandboxErrorCode, type LegacySandboxFile, type LegacySandboxHostAdapter, type LegacySandboxHostContext, type LegacySandboxTransport } from '@datafe-open/markdown-chart-echarts';",
