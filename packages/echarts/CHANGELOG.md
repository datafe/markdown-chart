...
- 35913fa: Raise the default narrow-table ECharts budget to 1,000,000 cells and 1,200,000
  JSON nodes, and allow legacy ChatBI CSV artifacts up to 64 MiB and 100,000 rows.
  The 200-column and five-second legacy boundaries remain in place.
...
- 4429a45: Apply the ECharts renderer node budget while validating options produced by the
